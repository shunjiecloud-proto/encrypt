...
func (x *GetPublicKeyResponse) GetPublicKeyId() string {
	if x != nil {
...
func (x *EncryptRequest) GetPublicKeyId() string {
	if x != nil {
		return x.PublicKeyId
	}
	return ""
...
func (x *DecryptRequest) GetPublicKeyId() string {
	if x != nil {
		return x.PublicKeyId
	}
	return ""
...
var file_encrypt_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0b, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x49, 0x64, 0x22, 0x2d,
